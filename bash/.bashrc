...
export OSH='/home/mramdin/.oh-my-bash'
...
alias vi="vim"
alias softwareupdate="sudo apt update && sudo apt upgrade -y && sudo apt autoremove -y; sudo snap refresh;if [ -e /var/run/reboot-required ];then sudo reboot;fi"
...
export VSCODE_REMOTE_SERVER_PORT=5000
